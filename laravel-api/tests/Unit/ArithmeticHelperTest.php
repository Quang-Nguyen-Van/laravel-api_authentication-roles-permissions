...
class ArithmeticHelperTest extends TestCase
{
     ...
     * @return void
     */
    public function test_add_can_sum_number_up()
    {
        $num1 = 5;
        $num2 = 10;
        $sum = $num1 + $num2;
        ...
        $this->assertSame($sum, $result, 'Does not add number correctly.');
    }
    ...
    public function test_add_cannot_take_in_array_argrument()
    {
        $this->expectException(InvalidArgumentException::class);
        $result = ArithmeticHelper::add(['abc']);
    }

    public function test_add_cannot_take_in_null_argrument()
    {
        $this->expectException(InvalidArgumentException::class);
        $result = ArithmeticHelper::add(null);
    }

    public function test_add_cannot_take_in_boolean_argrument()
    {
        $this->expectException(InvalidArgumentException::class);
        $result = ArithmeticHelper::add(true);
    }

    public function test_add_cannot_take_in_function_argrument()
    {
        $this->expectException(InvalidArgumentException::class);
